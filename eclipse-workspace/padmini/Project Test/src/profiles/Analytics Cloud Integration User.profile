...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>ArticleController</apexClass>
    ...
    <classAccesses>
        <apexClass>GetArticles</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>GetKnowledgeRecords</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Knowledge__kav.Article_true__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Policies__c.Account__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Policies__c.Status__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Policies__c.sub_status__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Policies__c-Customer layout</layout>
        <recordType>Policies__c.Customer</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Policies__c-Policies Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Policies__c-Policies Layout</layout>
        <recordType>Policies__c.Staff</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>false</modifyAllRecords>
        <object>My_First_Knowledge_Article__kav</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>false</allowCreate>
    ...
    <pageAccesses>
        <apexPage>datacategory</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
