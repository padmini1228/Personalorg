...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>SLA_Notifications/Stationary_Case_Email_notification_after_24_hours</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Email_notification_after_24_hours</fullName>
        <description>Email notification after 24 hours</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
    ...
    <alerts>
        <fullName>Email_notification_after_48_hours</fullName>
        <description>Email notification after 48 hours</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
    ...
    <alerts>
        <fullName>Email_notification_after_72_hours</fullName>
        <description>Email notification after 72 hours</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
    ...
    <alerts>
        <fullName>Stationary_Approval_Email_notification</fullName>
        <description>Stationary Approval Email notification</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>DefaultWorkflowUser</senderType>
        <template>SLA_Notifications/Stationary_Case_Approved</template>
    </alerts>
    <alerts>
        <fullName>Stationary_Rejected_Email_Notification</fullName>
        <description>Stationary Rejected Email Notification</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>DefaultWorkflowUser</senderType>
        <template>SLA_Notifications/Stationary_Case_Rejected</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        <fullName>Document_Approved</fullName>
        <field>Status</field>
        <literalValue>Approved</literalValue>
        <name>Document Approved</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Document_Marketing_Approved</fullName>
        <field>Status</field>
        <literalValue>Approved</literalValue>
        <name>Document Marketing Approved</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Document_Marketing_Rejected</fullName>
        <field>Status</field>
        <literalValue>Rejected</literalValue>
        <name>Document Marketing Rejected</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Document_Rejected</fullName>
        <field>Status</field>
        <literalValue>Rejected</literalValue>
        <name>Document Rejected</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>PPDG_Awaiting_Approval</fullName>
        <field>Status</field>
        <literalValue>Awaiting Approval</literalValue>
        <name>PPDG Awaiting Approval</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
...
Total_Time_Spent_on_Case__c  + Time_Spent_on_Case__c )</formula>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Case.RecordTypeId</field>
            <operation>notEqual</operation>
            <value>Complaint,IT System Access,IT Change Requests,IT Standard,Change Advisory Board Form,Stationary Case,Document Sign Off</value>
        </criteriaItems>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
...
Workflow notification for approval sent to Jay &amp; Abdul Majid</description>
    ...
    <rules>
        <fullName>Stationary Case Email notification</fullName>
        <active>true</active>
        <criteriaItems>
            <field>Case.Status</field>
            <operation>equals</operation>
        ...
        <criteriaItems>
            <field>Case.RecordTypeId</field>
            <operation>equals</operation>
            <value>Stationary Case</value>
        </criteriaItems>
        <criteriaItems>
            <field>Case.Created_Date_Letter__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>Email_notification_after_72_hours</name>
                <type>Alert</type>
            </actions>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Email_notification_after_48_hours</name>
                <type>Alert</type>
            </actions>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>Email_notification_after_24_hours</name>
                <type>Alert</type>
            </actions>
    ...
    <rules>
        <fullName>Stationary Case Test</fullName>
        <active>false</active>
        <criteriaItems>
            <field>Case.Created_Date_Letter__c</field>
            <operation>notEqual</operation>
